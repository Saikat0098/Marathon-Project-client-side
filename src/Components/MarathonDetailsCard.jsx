      ...
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl overflow-hidden transform transition duration-500 hover:scale-105 hover:shadow-2xl">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-6 flex flex-col justify-between">
            ...
            <div className="mt-6">
              <p className="text-xl font-semibold text-[#FD267D] mb-4">
                Total Apply:
                {total_count ? total_count : 0}
              </p>
              <Link to={`/marathonApplyForm/${_id}`}>
                <button className="py-3 px-6 bg-[#FD267D] text-white font-bold rounded-full hover:bg-[#FF5E6C] transition duration-300 transform hover:scale-105">
                  Apply Now
                </button>
              </Link>
            </div>
